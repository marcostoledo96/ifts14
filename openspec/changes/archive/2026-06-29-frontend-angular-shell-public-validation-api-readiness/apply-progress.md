...
| `npm start -- --configuration development --serve-path /certificados/` + Playwright | OK — `/certificados/` carga landing sin validar; las rutas `validar/{token}` renderizan los bloques correctos; `console errors: 0`. |
