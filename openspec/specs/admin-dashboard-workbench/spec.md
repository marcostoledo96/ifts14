# Especificación — admin-dashboard-workbench

## Propósito

Definir la mesa de trabajo del dashboard admin Angular 20: acciones, flujo operativo, pendientes honestos, actividad y resumen derivado de seams.

## Requirements

### Requirement: Panel Flujo de trabajo

El dashboard DEBE mostrar un panel instructivo «Flujo de trabajo» **antes** de «Pendientes de resolución» y **después** de Acciones. DEBE explicar brevemente el orden operativo y mostrar los cinco temas como etiquetas no navegables. DEBE ofrecer un CTA destacado a `/admin/guia`. NO DEBE duplicar la navegación del menú lateral con enlaces «Abrir» a Cursos/Alumnos/etc.
...
- **And** NO DEBE haber filas clicables hacia `/admin/cursos`, `/admin/alumnos`, `/admin/asistencias`, `/admin/certificaciones` ni `/admin/configuracion`
