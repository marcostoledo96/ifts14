...
| Specs | `openspec/AGENTS.md`, `openspec/specs/README.md`, `openspec/specs/repo-seguro/spec.md`, `openspec/specs/backend-contrato-api-certificados/spec.md`, `openspec/specs/backend-modelo-datos-certificados/spec.md`, `openspec/specs/frontend-ci-quality-gates/spec.md`, `openspec/specs/backend-ci-quality-gates/spec.md`, `openspec/specs/mariadb-ci-quality-gates/spec.md` |
