...
| P19 Folio PDF | `audit/p19-certs-pdf` | en curso | | Apply: honesty load-only + `mensajeErrorApi` descarga + filename `detalle.numero`; html2canvas intacto; verify pendiente |
