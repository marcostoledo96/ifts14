...
const pendientes = [
  ...
  },
  {
    ...
    detalle: "Impide el envío automático del certificado.",
    count: 12,
    icon: MailWarning,
    tone: "warning" as const,
  },
  {
    label: "Certificaciones pendientes de envío",
    detalle: "Emitidas y firmadas, aún no notificadas al alumno.",
    count: 5,
    icon: SendHorizontal,
    tone: "info" as const,
  },
  {
    label: "Requieren reenvío por modificación",
